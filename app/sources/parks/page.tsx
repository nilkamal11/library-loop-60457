...
const parkSources: ParkSource[] = [
  ...
  { name: 'Posen Park District', distance: '≈9 mi', status: 'feed', method: 'WordPress iCalendar', note: 'iCalendar feed is available; JSON is blocked.', url: 'https://posenparkdistrict.org/events/' },
