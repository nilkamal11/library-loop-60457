...
const calendarSources: CalendarSource[] = [
  ...
  { name: 'Forest Park Public Library', distance: 10.53, status: 'page', method: 'Browser event page', note: 'Queued overnight because the hosted server is blocked while a normal browser can open the official calendar.', url: 'https://cc.fppl.org/events/categories/forest-park-public-library/' },
