...
const configuredSources = [
  ...
  { id: 'summit-public-library', name: 'Summit Public Library District', distance: 3.85, status: 'manual', method: 'Wix visual event page', note: 'The overnight browser reads page text and metadata; flyer-only details stay pending review.', url: 'https://www.summitlibrary.info/events' },
  ...
  { id: 'forest-park-public-library', name: 'Forest Park Public Library', distance: 10.53, status: 'page', method: 'Browser event page', note: 'Queued overnight because the hosted server is blocked while a normal browser can open the official calendar.', url: 'https://cc.fppl.org/events/categories/forest-park-public-library/' },
  ...
  { id: 'melrose-park-public-library', name: 'Melrose Park Public Library', distance: 11.87, status: 'manual', method: 'Flyer/PDF review', note: 'The overnight browser checks the page; flyer-only details are not read automatically yet.', url: 'https://www.melrosepark.org/melrose-park-library-events/' },
