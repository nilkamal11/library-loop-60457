...
- Make the first screen an event-discovery surface. It must show a useful rolling seven-day agenda immediately, not an empty single-day view or a marketing page.
...
- Provide real controls for date, keyword, distance (5, 10, or 15 miles), category, and teen events. All filters must be clearable.
